...
<div class="container py-3">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-4 shadow-lg border-0">
            <!-- HEADER -->
            <div class="modal-header text-white rounded-top-4" style="background: linear-gradient(45deg, #ff6f91, #ff85a1);">
            ...
            <div class="modal-footer border-0">
                <button type="button" class="btn" data-bs-dismiss="modal" style="background-color: #ffccd5; color: #b23a48;">
                    <i class="fas fa-times me-1"></i> Batal
                </button>
                <button type="button" class="btn text-white" id="confirmProceed" style="background: linear-gradient(45deg, #ff6f91, #ff85a1);">
                ...
                <div class="row mt-4">
                    <div class="col-md-12 text-right">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="button" id="submit_btn" class="btn btn-outline-pink-soft">
