...
<div class="container-fluid py-3">
    <div class="card border-0 shadow rounded-4">
        <div class="card-header bg-pink-soft d-flex justify-content-between align-items-center rounded-top-4">
            <h4 class="fw-bold mb-0 text-dark">
                <i class="fas fa-door-open me-2"></i> Detail Kamar
            </h4>
            <a href="{{ route($prefix . '.rooms.index') }}" class="btn btn-sm btn-outline-secondary rounded-pill">
