            ...
            <div>
                <a class="d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#menuHotel" role="button"
                   ...
                   aria-controls="menuHotel">
                    ...
                    <i class="bi {{ request()->is($role . '/rooms*') || request()->is($role . '/guests*') || request()->is($role . '/bookings*') ? 'bi-chevron-up' : 'bi-chevron-down' }}"></i>
                </a>
                <div class="collapse {{ request()->is($role . '/rooms*') || request()->is($role . '/guests*') || request()->is($role . '/bookings*') ? 'show' : '' }}" id="menuHotel">
            ...
            <div>
                <a class="d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#menuData" role="button"
                   ...
                   aria-controls="menuData">
                    ...
                    <i class="bi {{ request()->is('admin/users*') || request()->is('admin/payments*') ? 'bi-chevron-up' : 'bi-chevron-down' }}"></i>
                </a>
                <div class="collapse {{ request()->is('admin/users*') || request()->is('admin/payments*') ? 'show' : '' }}" id="menuData">
                    ...
                    <a href="{{ route('admin.activities.index') }}" class="{{ request()->routeIs('admin.activities.*') ? 'active' : '' }}">
                        <i class="fa fa-file-invoice-dollar me-1"></i> Aktifitas User
                    </a>
                </div>
            </div>
            @endif
